...
<div class="main">
	...
	<div class="container">
		...
		method="post" onsubmit="return check()" enctype="multipart/form-data">
				...
				<input type="text" name="writeTitle" id="writeTitle"class="writeTitle" placeholder="제목을 입력하세요" maxlength="100" <c:if test="${boardDetail.board_title ne null }">value="${ boardDetail.board_title }"</c:if>>
