...
alert("로그인정보가 다릅니다. 정보는 DBA에 문의하세요");
</script>
</c:if>
<div class="container">
  <div class="screen">
    <div class="screen__content">
      <form class="login" action="/adminLogin" method="post">
        <div class="login__field">
          ...
          <input type="text" name="adminID" class="login__input" placeholder="관리자 ID를 입력해주세요">
        </div>
        <div class="login__field">
          <i class="login__icon fas fa-lock"></i>
          <input type="password" name="adminPW" class="login__input" placeholder="관리자 PW를 입력해주세요">
        </div>
