    ...
    <div>
        ...
        <form action="/accountInquiry" method="post">
            <div class="form-control find-form">
                ...
                <label class="form-control mt-4 mb-4" style="width: 675px; height: 80px; margin: 0 auto;" for="coupon">
                    <div style="width: 100px; height: 70px; float: left; padding-top: 25px; text-align: center; box-sizing: border-box;">
                        <input type="radio" style="width: 20px; height: 20px;" id="coupon">
                    </div>
                    <div class="mt-2">
                ...
                <button class="btn btn-primary mt-2 mb-3" style="width: 675px;">쿠폰 선택</button>
            </div>
        </form>
    </div>
</body>
